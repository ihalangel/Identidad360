...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-1/2 right-0 w-2/3 md:w-1/3 transform -translate-y-1/2 bg-background shadow-md z-10 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex flex-col h-full justify-center p-4 space-y-4">
